...
\multicolumn{3}{p{0.92\textwidth}}{\footnotesize\textit{Nota:} Por se tratar de protótipo acadêmico com dados fictícios ou autorizados, retenção, backup, restauração e disponibilidade contínua não integram a entrega. Esses controles deverão ser definidos em eventual adoção real, conforme a LGPD.} \\
\hline
\multicolumn{3}{l}{\footnotesize\textbf{Fonte:} Elaborado pelo grupo a partir dos requisitos preliminares.}
\end{longtable}
