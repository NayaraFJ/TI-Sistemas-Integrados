...
Nesse contexto, propõe-se o desenvolvimento de uma aplicação web no formato de Help Desk para apoiar a gestão de demandas de tráfego pago. O sistema funcionará como ponto único de contato para registrar, validar, triar, atribuir e acompanhar solicitações de clientes e da equipe. Ele deverá registrar o tipo de pedido, campanha relacionada, prioridade, responsável, prazo, status, comentários e evidências de execução. Dessa forma, pretende-se substituir parte das comunicações informais por um fluxo registrado, metrificado e profissional, favorecendo a organização do atendimento e o controle das atividades de campanhas digitais.
