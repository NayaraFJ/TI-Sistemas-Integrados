...
| ---------------------------------- | -------------------------------------------------------------------- |
| Augusto do Couto Avelar            | Revisor                                                              |
| Gabriel Fernandes de Araújo        |                                                                      |
| Gabriel Rocha Lopes                |                                                                      |
| Karine Kessen Gilberti Felix       | Banco de dados; modelo relacional, migrações e dados de demonstração |
| Lorrainy Pâmela Siqueira Ferreira  | Front-end                                                            |
| Maria Heloisa Aguiar Mendes        | Front-end                                                            |
...
As frentes abaixo organizam a distribuição de trabalho entre os oito integrantes. Os campos em branco permanecem abertos até decisão do grupo.
...
| Dados e modelo relacional | Entidades, relacionamentos, restrições, migrações e dados de demonstração. | Karine Kessen Gilberti Felix |
| Interface e front-end | Estrutura visual, navegação, componentes, responsividade e telas. | Lorrainy Pâmela Siqueira Ferreira; Maria Heloisa Aguiar Mendes |
...
| BL-02 | Revisar a introdução conforme retorno do orientador. | Texto revisado em `Trabalho/Artigo` e no Overleaf, com revisão cruzada registrada. | BL-01       | 28/08/2026         |              | Nayara Ferreira de Jesus Rodrigues; Augusto do Couto Avelar (revisor) | Em revisão   |
...
| ID    | Item                                                                                | Entrega verificável                                                                     | Dependência  | Conclusão prevista | Concluído em | Responsável                                                           | Situação     |
| ----- | ----------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ------------ | ------------------ | ------------ | --------------------------------------------------------------------- | ------------ |
| BL-04 | Consolidar introdução, problemática, justificativa e objetivos.                     | Seções coerentes no artigo.                                                             | BL-02        | 25/09/2026         |              | Nayara Ferreira de Jesus Rodrigues; Augusto do Couto Avelar (revisor) | Em revisão   |
...
| BL-06 | Refinar o esboço de baixa fidelidade.                                               | Painel, abertura de ticket e detalhe do ticket documentados.                            | BL-04        | 25/09/2026         |              | Lorrainy Pâmela Siqueira Ferreira; Maria Heloisa Aguiar Mendes        | Em revisão   |
...
| ID    | Item                                                   | Entrega verificável                                                  | Dependência   | Conclusão prevista | Concluído em | Responsável                                                           | Situação   |
| ----- | ------------------------------------------------------ | -------------------------------------------------------------------- | ------------- | ------------------ | ------------ | --------------------------------------------------------------------- | ---------- |
| BL-08 | Concluir o referencial / marco teórico.                | Fontes selecionadas, citações e referências consolidadas.            | BL-04         | 30/10/2026         |              | Nayara Ferreira de Jesus Rodrigues; Augusto do Couto Avelar (revisor) | Em revisão |
...
| BL-11 | Revisar protótipo contra requisitos prioritários.      | Cada tela cobre os caminhos prioritários.                            | BL-06, BL-09  | 30/10/2026         |              | Lorrainy Pâmela Siqueira Ferreira; Maria Heloisa Aguiar Mendes        | Em revisão |
...
| BL-13 | Preparar a entrega da 3ª Etapa.                        | Repositório atualizado e link enviado.                               | BL-08 a BL-12 | 30/10/2026         |              | Nayara Ferreira de Jesus Rodrigues                                    | A fazer    |

### 4ª Etapa — até 27/11

| ID    | Item                                                                     | Entrega verificável                                                                                    | Dependência         | Conclusão prevista | Concluído em | Responsável                                                                                                           | Situação   |
| ----- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------- | ------------------ | ------------ | --------------------------------------------------------------------------------------------------------------------- | ---------- |
| BL-14 | Consolidar metodologia e plano de validação.                             | Metodologia coerente com o estado real do projeto.                                                     | BL-09               | 27/11/2026         |              | Nayara Ferreira de Jesus Rodrigues; Augusto do Couto Avelar (revisor)                                                 | Em revisão |
...
| BL-16 | Criar o modelo relacional e as migrações iniciais.                       | Diagrama/modelo com entidades, chaves, relacionamentos, restrições e script de criação.                | BL-09, BL-15        | 27/11/2026         |              | Karine Kessen Gilberti Felix                                                                                          | A fazer    |
| BL-17 | Criar e versionar o contrato entre front-end e back-end.                 | Especificação de API com autenticação, rotas, parâmetros, corpos, respostas, erros e exemplos.         | BL-09, BL-15        | 27/11/2026         |              | Pedro Henrique Assuncao; Lorrainy Pâmela Siqueira Ferreira; Maria Heloisa Aguiar Mendes                               | A fazer    |
| BL-18 | Criar mocks e cenários de integração do contrato de API.                 | Dados de exemplo e casos de sucesso/erro consumíveis pelo front-end antes da API final.                | BL-17               | 27/11/2026         |              | Pedro Henrique Assuncao; Lorrainy Pâmela Siqueira Ferreira; Maria Heloisa Aguiar Mendes                               | A fazer    |
| BL-19 | Implementar autenticação, autorização por perfil e auditoria básica.     | Usuários autenticados acessam somente funções e tickets autorizados.                                   | BL-15, BL-16, BL-17 | 27/11/2026         |              | Pedro Henrique Assuncao; Karine Kessen Gilberti Felix                                                                 | A fazer    |
| BL-20 | Implementar cadastros e o fluxo principal de tickets no back-end.        | Clientes, campanhas, tipos de demanda, abertura, triagem, atribuição, estados e histórico persistidos. | BL-16, BL-17, BL-19 | 27/11/2026         |              | Pedro Henrique Assuncao; Karine Kessen Gilberti Felix                                                                 | A fazer    |
| BL-21 | Implementar estrutura visual, navegação e telas principais no front-end. | Interface responsiva para autenticação, painel, lista, abertura e detalhe.                             | BL-11, BL-15, BL-18 | 27/11/2026         |              | Lorrainy Pâmela Siqueira Ferreira; Maria Heloisa Aguiar Mendes                                                        | A fazer    |
| BL-22 | Integrar front-end, API e persistência no caminho principal.             | Demonstração de abertura até conclusão com dados de teste.                                             | BL-20, BL-21        | 27/11/2026         |              | Pedro Henrique Assuncao; Karine Kessen Gilberti Felix; Lorrainy Pâmela Siqueira Ferreira; Maria Heloisa Aguiar Mendes | A fazer    |
...
| BL-26 | Implementar filtros, painel e indicação de vencimento de prazo.             | Consulta de tickets por filtros e visão de acompanhamento.                                                                                                              | BL-20, BL-22         | 11/12/2026         |              | Lorrainy Pâmela Siqueira Ferreira; Maria Heloisa Aguiar Mendes | A fazer  |
...
| BL-34 | Realizar a revisão cruzada final do artigo.                                 | Checklist de coerência entre etapas, Overleaf, citações, referências, documentação de apoio, resumo, abstract e padrão PUC Minas; pendências corrigidas ou registradas. | BL-31                | 11/12/2026         |              | Augusto do Couto Avelar (revisor)                              | A fazer  |
